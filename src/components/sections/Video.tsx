                        ...
                        >
                            ...
                            >
                                ...
                                <div className="relative w-full aspect-9/16 bg-black">
                                    ...
                                    {/* Views Count Overlay */}
                                    {story.views && (
                                        <div className="absolute top-3 left-3 z-10 bg-black/60 backdrop-blur-md px-2 py-1 rounded-md border border-white/10 flex items-center gap-1.5 transition-transform duration-300 group-hover:scale-105">

        ...
        <div className="grid gap-12 lg:grid-cols-[1fr_1.1fr] lg:gap-20">
          ...
          <div className="flex flex-col justify-between gap-10">
            <div>
              ...
              <h2
                className="font-display text-4xl text-white md:text-5xl lg:text-6xl xl:text-7xl"
              ...
              <div className="flex flex-col gap-4">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-sm font-medium text-white">franzabadiacopywriter@gmail.com</p>
                  </div>
                </a>
              </div>
